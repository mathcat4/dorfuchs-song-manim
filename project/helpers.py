...
TXTCOL = mn.BLACK
AMCOL = mn.ManimColor("#CE6012")
GMCOL = mn.ManimColor("#519130")
QMCOL = mn.ManimColor("#238EA9")
HMCOL = mn.ManimColor("#715582")
RIGHTANGLECOL = mn.ManimColor("#828282")
ANGLECOL = mn.ManimColor("#D147BD")
REDCOL = mn.ManimColor("#E23222")
BLUECOL = mn.ManimColor("#1E5977")
