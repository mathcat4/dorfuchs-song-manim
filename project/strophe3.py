...
def construct_scene(scene: mn.Scene):
    ...
    # %scene.play(mn.Write(term7[2]), mn.Write(term7[3]), mn.Wiggle(geo.sega), run_time=0.9)
    # %scene.play(mn.Write(term7[4]), mn.Write(term7[5]), mn.Wiggle(geo.segb), run_time=0.9)
    # scene.wait(0.5)
    term8 = mn.MathTex(
